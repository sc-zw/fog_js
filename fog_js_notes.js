let rows = 30;//you can choose/change this
let cols = 30;//you can choose/change this
let delay = 500;//This is the number of milliseconds between updates


// here is where the visual representations of the 3 cell states are defined. we use \u{HHHH} to get unicode in hexidecimal
let flat = " ";
let fog = "\u2592";
let hill = "\u039B"

function print_loc_key() {
	for (let i = 0; i < rows*cols ; i++ ) {
   		if (i % cols == 0 ) process.stdout.write('\n');
  		process.stdout.write(String(i).padStart(3, '0') + ' ');
  	}
}


//here is a way to generate a cell location key, in this case with 30 rwos and 30 cols. Output below.
...
///We can start the cells as all flat and then you can add hills and fog
function blank_seed() {
	for (int i = 0; i < rows*cols; i++) cells[i] = flat;
}


function print_rule_template() {
	let labels = [ 'flat', 'fog', 'hill'];
	let arg;
	for (let i = 0; i < 81 ; i++ ) {
		for (let j = 0; j < 4 ; j++ ) {
			arg = i.toString(3).padStart(4,'0')
			arg = arg.split('').join(' + ')
			arg = arg.replaceAll('0','flat').replaceAll('1',' fog').replaceAll('2','hill');
			console.log('f['+arg+ '] =          ;');
		}
  	}
}

////This is the output from function above

////The pattern is f[NORTHWEST NORTH NORTHEAST CURRENT_THIS] = NEW_THIS ;
///This is actual code, once the the decision is placed between =  and ;

f[flat + flat + flat + flat] =          ;
f[flat + flat + flat + flat] =          ;
f[flat + flat + flat + flat] =          ;
f[flat + flat + flat + flat] =          ;
f[flat + flat + flat +  fog] =          ;
f[flat + flat + flat +  fog] =          ;
f[flat + flat + flat +  fog] =          ;
f[flat + flat + flat +  fog] =          ;
f[flat + flat + flat + hill] =          ;
f[flat + flat + flat + hill] =          ;
f[flat + flat + flat + hill] =          ;
f[flat + flat + flat + hill] =          ;
f[flat + flat +  fog + flat] =          ;
f[flat + flat +  fog + flat] =          ;
f[flat + flat +  fog + flat] =          ;
f[flat + flat +  fog + flat] =          ;
f[flat + flat +  fog +  fog] =          ;
...
f[flat + flat +  fog +  fog] =          ;
f[flat + flat +  fog +  fog] =          ;
f[flat + flat +  fog + hill] =          ;
f[flat + flat +  fog + hill] =          ;
f[flat + flat +  fog + hill] =          ;
f[flat + flat +  fog + hill] =          ;
f[flat + flat + hill + flat] =          ;
f[flat + flat + hill + flat] =          ;
f[flat + flat + hill + flat] =          ;
f[flat + flat + hill + flat] =          ;
f[flat + flat + hill +  fog] =          ;
f[flat + flat + hill +  fog] =          ;
f[flat + flat + hill +  fog] =          ;
f[flat + flat + hill +  fog] =          ;
f[flat + flat + hill + hill] =          ;
f[flat + flat + hill + hill] =          ;
f[flat + flat + hill + hill] =          ;
f[flat + flat + hill + hill] =          ;
f[flat +  fog + flat + flat] =          ;
f[flat +  fog + flat + flat] =          ;
f[flat +  fog + flat + flat] =          ;
f[flat +  fog + flat + flat] =          ;
f[flat +  fog + flat +  fog] =          ;
...
f[flat +  fog + hill +  fog] =          ;
f[flat +  fog + hill +  fog] =          ;
f[flat +  fog + hill + hill] =          ;
f[flat +  fog + hill + hill] =          ;
f[flat +  fog + hill + hill] =          ;
f[flat +  fog + hill + hill] =          ;
f[flat + hill + flat + flat] =          ;
f[flat + hill + flat + flat] =          ;
f[flat + hill + flat + flat] =          ;
f[flat + hill + flat + flat] =          ;
f[flat + hill + flat +  fog] =          ;
f[flat + hill + flat +  fog] =          ;
f[flat + hill + flat +  fog] =          ;
f[flat + hill + flat +  fog] =          ;
f[flat + hill + flat + hill] =          ;
f[flat + hill + flat + hill] =          ;
f[flat + hill + flat + hill] =          ;
f[flat + hill + flat + hill] =          ;
f[flat + hill +  fog + flat] =          ;
f[flat + hill +  fog + flat] =          ;
f[flat + hill +  fog + flat] =          ;
f[flat + hill +  fog + flat] =          ;
f[flat + hill +  fog +  fog] =          ;
...
f[flat + hill +  fog +  fog] =          ;
f[flat + hill +  fog +  fog] =          ;
f[flat + hill +  fog + hill] =          ;
f[flat + hill +  fog + hill] =          ;
f[flat + hill +  fog + hill] =          ;
f[flat + hill +  fog + hill] =          ;
f[flat + hill + hill + flat] =          ;
f[flat + hill + hill + flat] =          ;
f[flat + hill + hill + flat] =          ;
f[flat + hill + hill + flat] =          ;
f[flat + hill + hill +  fog] =          ;
f[flat + hill + hill +  fog] =          ;
f[flat + hill + hill +  fog] =          ;
f[flat + hill + hill +  fog] =          ;
f[flat + hill + hill + hill] =          ;
f[flat + hill + hill + hill] =          ;
f[flat + hill + hill + hill] =          ;
f[flat + hill + hill + hill] =          ;
f[ fog + flat + flat + flat] =          ;
f[ fog + flat + flat + flat] =          ;
f[ fog + flat + flat + flat] =          ;
f[ fog + flat + flat + flat] =          ;
f[ fog + flat + flat +  fog] =          ;
...
f[ fog + hill + hill +  fog] =          ;
f[ fog + hill + hill +  fog] =          ;
f[ fog + hill + hill + hill] =          ;
f[ fog + hill + hill + hill] =          ;
f[ fog + hill + hill + hill] =          ;
f[ fog + hill + hill + hill] =          ;
f[hill + flat + flat + flat] =          ;
f[hill + flat + flat + flat] =          ;
f[hill + flat + flat + flat] =          ;
f[hill + flat + flat + flat] =          ;
f[hill + flat + flat +  fog] =          ;
f[hill + flat + flat +  fog] =          ;
f[hill + flat + flat +  fog] =          ;
f[hill + flat + flat +  fog] =          ;
f[hill + flat + flat + hill] =          ;
f[hill + flat + flat + hill] =          ;
f[hill + flat + flat + hill] =          ;
f[hill + flat + flat + hill] =          ;
f[hill + flat +  fog + flat] =          ;
f[hill + flat +  fog + flat] =          ;
f[hill + flat +  fog + flat] =          ;
f[hill + flat +  fog + flat] =          ;
f[hill + flat +  fog +  fog] =          ;
...
f[hill + flat +  fog +  fog] =          ;
f[hill + flat +  fog +  fog] =          ;
f[hill + flat +  fog + hill] =          ;
f[hill + flat +  fog + hill] =          ;
f[hill + flat +  fog + hill] =          ;
f[hill + flat +  fog + hill] =          ;
f[hill + flat + hill + flat] =          ;
f[hill + flat + hill + flat] =          ;
f[hill + flat + hill + flat] =          ;
f[hill + flat + hill + flat] =          ;
f[hill + flat + hill +  fog] =          ;
f[hill + flat + hill +  fog] =          ;
f[hill + flat + hill +  fog] =          ;
f[hill + flat + hill +  fog] =          ;
f[hill + flat + hill + hill] =          ;
f[hill + flat + hill + hill] =          ;
f[hill + flat + hill + hill] =          ;
f[hill + flat + hill + hill] =          ;
f[hill +  fog + flat + flat] =          ;
f[hill +  fog + flat + flat] =          ;
f[hill +  fog + flat + flat] =          ;
f[hill +  fog + flat + flat] =          ;
f[hill +  fog + flat +  fog] =          ;
...
f[hill +  fog + hill +  fog] =          ;
f[hill +  fog + hill +  fog] =          ;
f[hill +  fog + hill + hill] =          ;
f[hill +  fog + hill + hill] =          ;
f[hill +  fog + hill + hill] =          ;
f[hill +  fog + hill + hill] =          ;
f[hill + hill + flat + flat] =          ;
f[hill + hill + flat + flat] =          ;
f[hill + hill + flat + flat] =          ;
f[hill + hill + flat + flat] =          ;
f[hill + hill + flat +  fog] =          ;
f[hill + hill + flat +  fog] =          ;
f[hill + hill + flat +  fog] =          ;
f[hill + hill + flat +  fog] =          ;
f[hill + hill + flat + hill] =          ;
f[hill + hill + flat + hill] =          ;
f[hill + hill + flat + hill] =          ;
f[hill + hill + flat + hill] =          ;
f[hill + hill +  fog + flat] =          ;
f[hill + hill +  fog + flat] =          ;
f[hill + hill +  fog + flat] =          ;
f[hill + hill +  fog + flat] =          ;
f[hill + hill +  fog +  fog] =          ;
...
f[hill + hill +  fog +  fog] =          ;
f[hill + hill +  fog +  fog] =          ;
f[hill + hill +  fog + hill] =          ;
f[hill + hill +  fog + hill] =          ;
f[hill + hill +  fog + hill] =          ;
f[hill + hill +  fog + hill] =          ;
f[hill + hill + hill + flat] =          ;
f[hill + hill + hill + flat] =          ;
f[hill + hill + hill + flat] =          ;
f[hill + hill + hill + flat] =          ;
f[hill + hill + hill +  fog] =          ;
f[hill + hill + hill +  fog] =          ;
f[hill + hill + hill +  fog] =          ;
f[hill + hill + hill +  fog] =          ;
f[hill + hill + hill + hill] =          ;
f[hill + hill + hill + hill] =          ;
f[hill + hill + hill + hill] =          ;
f[hill + hill + hill + hill] =          ;
